...
namespace DoctrineProxy\__CG__\Skimpy\CMS;
...
class ContentItem extends \Skimpy\CMS\ContentItem implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'slug', 'title', 'date', 'type', 'content', 'description', 'excerpt', 'seoTitle', 'uri', 'template', 'terms', 'metadata'];
        }
     ...
     * {@inheritDoc}
     */
    public function hasTerm(\Skimpy\CMS\Term $term)
    {
     ...
     * {@inheritDoc}
     */
    public function removeTerm(\Skimpy\CMS\Term $term)
    {
     ...
     * {@inheritDoc}
     */
    public function getTaxonomy($taxKey)
    {
     ...
     * {@inheritDoc}
     */
    public function hasTaxonomy($taxKey)
    {
